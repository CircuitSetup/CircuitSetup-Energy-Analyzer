...
_DEMO_SOURCE_VALUES: dict[str, dict[SensorRole, float]] = {
    ...
    "hvac_l1": {
        SensorRole.ENERGY: 108.4,
        SensorRole.REAL_POWER: 1920.0,
        SensorRole.CURRENT: 16.8,
        SensorRole.POWER_FACTOR: 0.95,
        SensorRole.REACTIVE_POWER: 620.0,
        SensorRole.APPARENT_POWER: 2021.0,
        SensorRole.FREQUENCY: 60.0,
    },
    "hvac_l2": {
        SensorRole.ENERGY: 106.4,
        SensorRole.REAL_POWER: 1830.0,
        SensorRole.CURRENT: 16.1,
        SensorRole.POWER_FACTOR: 0.95,
        SensorRole.REACTIVE_POWER: 590.0,
        SensorRole.APPARENT_POWER: 1926.0,
        SensorRole.FREQUENCY: 60.0,
    },
    "water_heater_l1": {
    ...
    "car_charger_l1": {
        SensorRole.ENERGY: 84.7,
        SensorRole.REAL_POWER: 3600.0,
        SensorRole.CURRENT: 30.1,
        SensorRole.POWER_FACTOR: 0.99,
        SensorRole.REACTIVE_POWER: 330.0,
        SensorRole.APPARENT_POWER: 3636.0,
        SensorRole.FREQUENCY: 60.0,
    },
    "car_charger_l2": {
        SensorRole.ENERGY: 84.3,
        SensorRole.REAL_POWER: 3580.0,
        SensorRole.CURRENT: 29.8,
        SensorRole.POWER_FACTOR: 0.99,
        SensorRole.REACTIVE_POWER: 320.0,
        SensorRole.APPARENT_POWER: 3616.0,
        SensorRole.FREQUENCY: 60.0,
    },
    "pool_pump": {
