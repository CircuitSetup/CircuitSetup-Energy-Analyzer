...
PANEL_MODULE_VERSION = "20260813-4"
...
NILM_WORKSPACE_COLLECTION_API_PATH = f"/api/{DOMAIN}/nilm_workspace/collection"
NILM_WORKSPACE_ITEM_API_PATH = f"/api/{DOMAIN}/nilm_workspace/item"
NILM_WORKSPACE_HISTORY_API_PATH = f"/api/{DOMAIN}/nilm_workspace_history"
NILM_INTERVAL_EVIDENCE_API_PATH = f"/api/{DOMAIN}/nilm_interval_evidence"
