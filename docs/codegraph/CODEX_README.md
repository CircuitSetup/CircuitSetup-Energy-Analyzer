...
4. Before editing a module:
   - inspect the generated local graph when exact imports matter;
...
6. Regenerate the local graph after structural changes.
7. Do not commit generated graph output.
